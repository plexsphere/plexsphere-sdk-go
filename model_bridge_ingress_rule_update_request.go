...
// checks if the BridgeIngressRuleUpdateRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BridgeIngressRuleUpdateRequest{}
...
type _BridgeIngressRuleUpdateRequest BridgeIngressRuleUpdateRequest
...
func NewBridgeIngressRuleUpdateRequest(sniHost string, targetNodeId string, targetPort int32) *BridgeIngressRuleUpdateRequest {
	this := BridgeIngressRuleUpdateRequest{}
...
func (o BridgeIngressRuleUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o BridgeIngressRuleUpdateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BridgeIngressRuleUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBridgeIngressRuleUpdateRequest := _BridgeIngressRuleUpdateRequest{}

	err = json.Unmarshal(data, &varBridgeIngressRuleUpdateRequest)

	if err != nil {
		return err
	}

	*o = BridgeIngressRuleUpdateRequest(varBridgeIngressRuleUpdateRequest)
...
type NullableBridgeIngressRuleUpdateRequest struct {
	value *BridgeIngressRuleUpdateRequest
	isSet bool
}

func (v NullableBridgeIngressRuleUpdateRequest) Get() *BridgeIngressRuleUpdateRequest {
	return v.value
}

func (v *NullableBridgeIngressRuleUpdateRequest) Set(val *BridgeIngressRuleUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBridgeIngressRuleUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBridgeIngressRuleUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBridgeIngressRuleUpdateRequest(val *BridgeIngressRuleUpdateRequest) *NullableBridgeIngressRuleUpdateRequest {
	return &NullableBridgeIngressRuleUpdateRequest{value: val, isSet: true}
}

func (v NullableBridgeIngressRuleUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBridgeIngressRuleUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
