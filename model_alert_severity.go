...
// AlertSeverity Recorded severity classification of an alert rule.
type AlertSeverity string

// List of AlertSeverity
const (
	ALERTSEVERITY_AlertSeverityInfo        AlertSeverity = "info"
	ALERTSEVERITY_AlertSeverityWarning     AlertSeverity = "warning"
	ALERTSEVERITY_AlertSeverityCritical    AlertSeverity = "critical"
	ALERTSEVERITY_UNKNOWN_DEFAULT_OPEN_API AlertSeverity = "unknown_default_open_api"
)
...
func (v *AlertSeverity) UnmarshalJSON(src []byte) error {
	...
	*v = ALERTSEVERITY_UNKNOWN_DEFAULT_OPEN_API
	return nil
}
